...
//       renderItem={({ item }) => (
//         <View
//           className="bg-white p-6 mt-4 rounded-lg shadow-lg flex-row justify-between items-center"
//           style={{ marginHorizontal: 16 }} // Added margin to make cards more prominent
//         >
//           <View className="flex-row items-center">
//             <Image
//               source={{ uri: `${BASE_URL}/items_uploads/${item.image}` }}
//               className="w-20 h-20 rounded-lg mr-4" // Increased image size
//               style={{ resizeMode: "contain" }}
//             />
//             <View>
//               <Text
...
//           </View>
//           <TouchableOpacity
//             className="bg-[#FF6B6B] p-3 rounded-lg"
//             onPress={() => console.log("Added to cart:", item.itemName)}
//           >
//             <Text
//               style={{
//                 fontFamily: FontFamily.poppinsSemiBold,
...
//       )}
//       keyExtractor={(item, index) => index.toString()}
//       contentContainerStyle={{ paddingBottom: 20 }} // Increased padding to ensure proper spacing
//     />
//   );
...
//                         data={category}
//                         renderItem={({ item }) => (
//                           <View className="w-1/3 p-2" style={{ alignItems: "center" }}>
//                             <View
//                               className="bg-white rounded-lg shadow w-full py-1"
//                               style={{
//                                 alignItems: "center",
